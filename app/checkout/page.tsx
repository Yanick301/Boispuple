              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="card-premium p-8">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center p-4 border-2 border-wood-200 rounded-xl cursor-pointer hover:border-fire-500 transition">
                      <input
                        type="radio"
                        name="payment"
                        value="card"
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-wood-900">Банковская карта</div>
                        <div className="text-sm text-wood-600">Оплата онлайн</div>
                      </div>
                    </label>
                    <label className="flex items-center p-4 border-2 border-wood-200 rounded-xl cursor-pointer hover:border-fire-500 transition">
                      <input
                      ...
                      />
                      <div className="flex-1">
                        <div className="font-semibold text-wood-900">Наличными при получении</div>
                        <div className="text-sm text-wood-600">Оплата курьеру</div>
                      </div>
                    </label>
                  </div>
                </div>
